...
struct ImColor
{
    ...
    static ImColor White()  { return ImColor(255, 255, 255, 255); }
    static ImColor Red()    { return ImColor(255,   0,   0, 255); }
    static ImColor Green()  { return ImColor(  0, 255,   0, 255); }
    static ImColor Blue()   { return ImColor(  0,   0, 255, 255); }
    static ImColor Orange() { return ImColor(255, 155,   0, 255); }
    static ImColor Yellow() { return ImColor(255, 255,   0, 255); }
    static ImColor Black()  { return ImColor(  0,   0,   0, 255); }
    static ImColor Purple() { return ImColor( 40,  45, 225, 255); }
    static ImColor Magenta(){ return ImColor(230,  40, 240, 255); }
    static ImColor pwned()  { return ImColor(199, 123, 255, 255); }
    static ImColor PastelPink() { return ImColor(255, 209, 220, 255); }    
};
