...
public:
    ...
    {
        typedef void (* odraw_line)(void*, int, int, int, int);
        return getvfunc<odraw_line>(this, 19)(this, x0, y0, x1, y1);
    }
    ...
    HFONT create_font()
    {
        typedef HFONT (* ocreate_font)(void*);
        return getvfunc<ocreate_font>(this, 71)(this);
    }
    ...
    void draw_polygon(int vtxCount, FontVertex_t *vtx, bool bClipVertices = true)
    {
        typedef void (* odraw_polygon)(void*, int, FontVertex_t*, bool);
        return getvfunc<odraw_polygon>(this, 106)(this, vtxCount, vtx, bClipVertices);
    }
    ...
    void LockCursor()
    {
        ...
        return getvfunc<LockCursorFn>(this, 67)(this);
    }
    ...
    void PlaySound(const char* fileName)
    {
        ...
        return getvfunc<PlaySoundFn>(this, 82)(this, fileName);
    }
